...
//AuthorLoginRequired -
func AuthorLoginRequired(next httprouter.Handle) httprouter.Handle {
	...
	return func(w http.ResponseWriter, r *http.Request, ps httprouter.Params) {
		if r.Header["Token"] != nil {
			...
			if token.Valid {
				// fmt.Println(token.Claims.(jwt.MapClaims)["logged-author"].(map[string]interface{})["email"])
...
//AuthorsLoginReequired -
func AuthorsLoginReequired(next httprouter.Handle) httprouter.Handle { //middleware to check is user is logged in or not
	return func(w http.ResponseWriter, r *http.Request, ps httprouter.Params) {
...
// //AuthorLoginRequired -
// func AuthorLoginRequired(next http.HandlerFunc) http.HandlerFunc {
